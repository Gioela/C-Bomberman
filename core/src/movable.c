...
{
    float new_x = movable->x + delta_x;             // nuova coordinata in cui dovrebbe finire il movable
    float new_y = movable->y + delta_y;             // nuova coordinata in cui dovrebbe finire il movable
